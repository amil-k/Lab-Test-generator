...
import type { MemoryEvictionMode } from 'next/dist/build/swc/types';
...
export declare const defaultConfig: Readonly<{
    ...
    generateEtags: true;
    pageExtensions: string[];
    instrumentationClientInject: never[];
