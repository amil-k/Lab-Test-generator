...
import type { Project, Update as TurbopackUpdate } from 'next/dist/build/swc/types';
...
import type { CacheIndicatorState, ServerCacheStatus } from 'next/dist/next-devtools/dev-overlay/cache-indicator';
...
import type { AnyStream } from 'next/dist/server/app-render/stream-ops';
...
export interface NextJsHotReloaderInterface {
    ...
    ensurePage({ page, clientOnly, appPaths, definition, isApp, url, subscribeToChanges, }: {
        page: string;
        clientOnly: boolean;
