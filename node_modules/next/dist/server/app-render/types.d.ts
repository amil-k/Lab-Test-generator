...
import type { ExperimentalConfig, NextConfigComplete, PrefetchInliningConfig, ValidationLevel } from 'next/dist/server/config-shared';
...
export interface RenderOptsPartial {
    ...
    cacheLifeProfiles: import('next/dist/server/config-shared').ResolvedCacheLifeProfiles;
