...
import type { WorkUnitStore, PrerenderStoreModern, ValidationStoreClient, PrerenderStoreModernServer } from 'next/dist/server/app-render/work-unit-async-storage.external';
