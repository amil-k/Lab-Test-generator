...
import type { ResolvedCacheLifeProfiles } from 'next/dist/server/config-shared';
import type { SharedCacheResult } from 'next/dist/server/use-cache/use-cache-wrapper';
import type { ValidationLevel } from 'next/dist/server/config-shared';
