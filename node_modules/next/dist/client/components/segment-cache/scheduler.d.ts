...
import { EntryStatus, type SegmentCacheEntry } from 'next/dist/client/components/segment-cache/cache';
import type { RouteCacheKey } from 'next/dist/client/components/segment-cache/cache-key';
import { FetchStrategy, type PrefetchTaskFetchStrategy, PrefetchPriority } from 'next/dist/client/components/segment-cache/types';
import type { CacheMap } from 'next/dist/client/components/segment-cache/cache-map';
import type { NavigationLockPrefetch } from 'next/dist/client/components/segment-cache/navigation-testing-lock';
