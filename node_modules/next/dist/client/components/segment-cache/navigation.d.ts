import type { CacheNodeSeedData, FlightRouterState, ScrollRef } from 'next/dist/shared/lib/app-router-types';
import type { CacheNode } from 'next/dist/shared/lib/app-router-types';
import type { HeadData } from 'next/dist/shared/lib/app-router-types';
import type { NormalizedFlightData } from 'next/dist/client/flight-data-helpers';
import { FreshnessPolicy, type NavigationLock } from 'next/dist/client/components/router-reducer/ppr-navigations';
import { type SegmentCacheEntry, type RouteTree, type FulfilledRouteCacheEntry } from 'next/dist/client/components/segment-cache/cache';
import type { CacheMap } from 'next/dist/client/components/segment-cache/cache-map';
import type { PageVaryPath } from 'next/dist/client/components/segment-cache/vary-path';
import type { AppRouterState } from 'next/dist/client/components/router-reducer/router-reducer-types';
...
export declare function completeTraverseNavigation(state: AppRouterState, url: URL, renderedSearch: string, cache: CacheNode, tree: FlightRouterState, nextUrl: string | null): {
    ...
    focusAndScrollRef: import("next/dist/client/components/router-reducer/router-reducer-types").FocusAndScrollRef;
    cache: CacheNode;
