...
import type { ExternalObject, RefCell, NapiTurboEngineOptions, NapiSourceDiagnostic, NapiProjectOptions, NapiPartialProjectOptions, NapiCodeFrameOptions, NapiCodeFrameLocation, TraceServerHandle, TraceQueryOptions, TraceQueryResult, MemoryEvictionMode } from 'next/dist/build/swc/generated-native';
...
export interface NodeJsChunkListUpdate {
    ...
    chunks?: Record<string, {
        type: 'added' | 'deleted' | 'total' | 'partial';
    }>;
}
...
export interface Project {
    ...
    allHmrEvents(target: import('next/dist/build/swc').HmrTarget.Server): AsyncIterableIterator<TurbopackResult<NodeJsHmrUpdate>>;
