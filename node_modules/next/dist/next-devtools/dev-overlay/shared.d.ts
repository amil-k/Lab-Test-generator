...
import type { RequestInsight, RequestInsightsSnapshot } from 'next/dist/next-devtools/shared/request-insights';
...
export declare const ACTION_INSTANT_ERRORS_CLEAR = "instant-errors-clear";
export declare const ACTION_REQUEST_INSIGHTS_SNAPSHOT = "request-insights-snapshot";
export declare const ACTION_REQUEST_INSIGHTS_UPDATE = "request-insights-update";
export declare function updateRequestInsights(currentRequests: readonly RequestInsight[], insight: RequestInsight): RequestInsight[];
...
export type DispatcherEvent = BuildOkAction | BuildErrorAction | BeforeFastRefreshAction | FastRefreshAction | UnhandledErrorAction | UnhandledRejectionAction | VersionInfoAction | CacheIndicatorAction | StaticIndicatorAction | DebugInfoAction | DevIndicatorAction | ErrorOverlayOpenAction | ErrorOverlayCloseAction | ErrorOverlayToggleAction | BuildingIndicatorShowAction | BuildingIndicatorHideAction | RenderingIndicatorShowAction | RenderingIndicatorHideAction | DevToolsIndicatorPositionAction | DevToolsPanelPositionAction | DevToolsScaleAction | DevToolUpdateRouteStateAction | DevIndicatorSetAction | DevToolsConfigAction | CacheOnlyToggleAction | InstantNavResetAction | InstantErrorsClearAction | RequestInsightsSnapshotAction | RequestInsightsUpdateAction;
export declare function getInstantErrorRoute(error: unknown): string | null;
export declare function routeTemplateMatchesPath(template: string, path: string): boolean;
